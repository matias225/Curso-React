...
export const AdminSidebar: React.FC<SidebarProps> = ({ isCollapsed, onToggle }) => {
  ...
  const menuItems = [
    ...
    { icon: ShoppingCart, label: 'Ordeness' },
    { icon: FileText, label: 'Reportess' },
    { icon: Bell, label: 'Notificaciones' },
    { icon: Settings, label: 'Ajustes' },
    { icon: HelpCircle, label: 'Ayudas' },
  ];
      ...
      {!isCollapsed && (
        <div className="p-4 border-t border-gray-200">
          <div className="flex items-center space-x-3 p-3 rounded-lg hover:bg-gray-50 transition-colors cursor-pointer">
            <div className="w-10 h-10 gradient-to-br from-blue-500 to-purple-600 rounded-full flex items-center justify-center text-black font-semibold">
